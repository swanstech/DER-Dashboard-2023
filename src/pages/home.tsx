...
// import HeaderComponent from 'n/components/Header';
// import { IconLogin } from '@tabler/icons-react';
// import { MainLinks } from 'n/components/NavbarLinks/MainLinks';
// import { useAuth } from '../contexts/'; // Replace 'path-to-your' with the actual path to AuthContext

// const googleMapsApiKey = process.env.GOOGLE_MAPS_API_KEY || "";

// const Home: React.FC = () => {
//   const router = useRouter();
//   const { isAuth, userRoles, userProfile, keycloak } = useAuth();
//   let lastUserActivityTimestamp = Date.now();
...
//       if (inactiveDuration >= inactivityTimeout && keycloak) {
//         // If the user has been inactive for more than 10 minutes, refresh token
//         refreshToken();
//       }
//     }, 60 * 1000);
...
//       clearInterval(inactivityCheckInterval);
//     };
//   }, [keycloak, lastUserActivityTimestamp]);
...
//     <div className="page-layout">
//       {/* Pass userRoles to MainLinks component */}
//       <MainLinks userRoles={userRoles} />

//       <HeaderComponent userRoles={userRoles} userProfile={userProfile} keycloakInstance={keycloak} />
//       <div className="top">
//         <div className="left">
//           <div className="left-heading">
//             <Activity size="3rem" color='green' />
